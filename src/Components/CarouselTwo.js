...
export default function CarouselTwo() {
    return (
        <div style={{ minWidth: '100%', height: '60vh', backgroundImage: 'linear-gradient(-60deg, #ff5858 0%, #f09819 100%)', borderRadius: '10px', border: '0px' }}>
            <div style={{ position: 'relative', width: '100%', borderRadius: '10px', border: '0px', height: '100%', backgroundImage: `url(http://localhost:3000/images/iphone.png)`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'right bottom' }}>
